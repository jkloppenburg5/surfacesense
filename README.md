...
Surfacesense is an application that classifies and maps road surface types using GPS data and accelerometer measurements. Aimed at cyclists, runners, planners, and researchers, the app provides an integrated platform for identifying surface conditions along a route and improving the accuracy of existing maps.
